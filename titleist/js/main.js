...
$('.btn-menu').on('click',function(){
    ...
    $('.menu li').on('click',function(e){
        ...
        $('article').on('mouseover',function(){
            ...
            /*블러 이미지 적용*/
        $("#section1").stop().animate({opacity:0.6}, function(){
            $(this).css({'background-image': "url('img/section1-imgbig-blur2.jpg')"})
            .animate({opacity:1},2000);
    });


            $(this).stop().animate({width:'450px'},1000,function(){
	...
	$("#section1").stop().animate({opacity: 0.6}, function(){
        $(this).css({'background-image': "url('img/section1-imgbig.jpg')"})
